...
#ifndef CAMIMUCALIB_QUAT_H
#define CAMIMUCALIB_QUAT_H

#include "Type.h"
#include "utils/quat_ops.h"

namespace camimucalib_type {
    ...
    public:
        ...
        void update(const Eigen::VectorXd dx) override {
            ...
            dq << .5 * dx, 1.0;
            dq = camimucalib_core::quatnorm(dq);

            //Update estimate and recompute R
            set_value(camimucalib_core::quat_multiply(dq, _value));
        ...
        */
        void set_value(const Eigen::MatrixXd new_value) override {
            ...
            _R = camimucalib_core::quat_2_Rot(new_value);
        }
        ...
        */
        void set_fe(const Eigen::MatrixXd new_value) override {
            ...
            //compute associated rotation
            _Rfe = camimucalib_core::quat_2_Rot(new_value);
        }
